<template>
    <section class="flex min-h-0 flex-col gap-3">
        ...
        <p class="text-pretty text-sm text-neutral-600">
            ...
            Python, Automation, Linux, Terraform, and AWS—skills I've been
        ...
        <p class="text-pretty text-sm text-neutral-600">
            ...
            at Sanofi as a DevOps Developer during my final year of the BUT.
            Sanofi has continued to support me by hiring me as a DevOps Cloud
            Engineer throughout my engineering studies. This role is enhancing
            my skills in DevOps, particularly with GitHub Actions, Python,
            Terraform, and AWS. I also recently earned the GitHub Foundations
            certification, demonstrating my knowledge of GitHub.
        </p>
    </section>
</template>
