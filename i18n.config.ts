    ...
    messages: {
        en: {
            about: {
                ...
                3: 'I hold a BUT in Computer Science from the University of Lyon 1 andam currently pursuing a three-year engineering degree at CPE Lyon, specializing in Computer Engineering. I completed an apprenticeship at Sanofi as a DevOps Developer during my final year of the BUT. Sanofi has continued to support me by hiring me as a DevOps Cloud Engineer throughout my engineering studies. This role is enhancing my skills in DevOps, particularly with GitHub Actions, Python,Terraform, and AWS. I also recently earned the GitHub Foundations certification, demonstrating my knowledge of GitHub.'
            },
            view: 'Live',
            sanofi: {
        ...
        fr: {
            about: {
                1: "Bonjour! Je suis un développeur passionné par la technologie et tout ce qui touche à l'informatique. Au fil des ans, je me suis consacré à la création de divers projets personnels, animé par ma passion pour l'apprentissage et l'exploration de nouvelles technologies.",
                ...
                3: "Je suis titulaire d'un BUT en informatique de l'Université Lyon 1 et je poursuis actuellement un diplôme d'ingénieur de trois ans à CPE Lyon, spécialisé en génie informatique. J'ai effectué un apprentissage chez Sanofi en tant que développeur DevOps lors de ma dernière année de BUT. Sanofi a continué à me soutenir en m'embauchant en tant qu'ingénieur cloud DevOps tout au long de mes études d'ingénieur. Ce rôle me permet de renforcer mes compétences en DevOps, en particulier avec GitHub Actions, Python, Terraform et AWS. J'ai également récemment obtenu la certification GitHub Foundations, démontrant mes connaissances sur GitHub."
            },
            view: 'Voir',
            sanofi: {
